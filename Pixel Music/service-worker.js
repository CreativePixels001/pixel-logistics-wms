...
const CACHE_NAME = 'pixel-music-v1.18.0'; // 🛡️ Jan 22, 2026: AUTOPLAY FIX - Clear search results after user selection, max 25min duration
const urlsToCache = [
    '/',
    '/index.html',
    '/style.css',
...
self.addEventListener('push', (event) => {
    ...
    event.waitUntil(self.registration.showNotification('Pixel Music', options));
});
